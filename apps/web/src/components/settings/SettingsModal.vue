...
const keycloakAccountUrl = computed(() => {
  ...
  if (typeof window === 'undefined') return 'http://fortidashboard.local:9080/realms/fortidashboard/account'
  const port = '9080'
  const host = window.location.hostname || 'fortidashboard.local'
