...
const presets: ThemePreset[] = [
  { id: 'custom', name: 'Custom Builder', mode: 'dark', primary: '', secondary: '', neutral: '' },
  { id: 'fortinet', name: 'Fortinet Classic', mode: 'dark', primary: '#ea0029', secondary: '#5f78a3', neutral: '#1a1c1e' },
  { id: 'cyber', name: 'Cyber Blue', mode: 'dark', primary: '#00e5ff', secondary: '#0f766e', neutral: '#0f172a' },
  { id: 'emerald', name: 'Toxic Emerald', mode: 'dark', primary: '#00ff66', secondary: '#166534', neutral: '#052e16' },
  { id: 'light_ocean', name: 'Light Ocean', mode: 'light', primary: '#0284c7', secondary: '#38bdf8', neutral: '#f8fafc' },
  { id: 'opera', name: 'Opera Pink', mode: 'dark', primary: '#fa196e', secondary: '#9d174d', neutral: '#121212' },
]
    ...
    <div class="bg-theme-bg border border-theme-border rounded-2xl w-full max-w-6xl max-h-[90vh] shadow-2xl flex flex-col overflow-hidden text-theme-text transition-colors duration-300">
      ...
      <div class="flex-1 overflow-hidden flex flex-col lg:flex-row">
        ...
        <aside class="w-full lg:w-[340px] border-r border-theme-border bg-theme-panel p-6 flex flex-col gap-8 overflow-y-auto transition-colors duration-300">
          ...
          <!-- Presets Section -->
          <section>
            <h3 class="text-sm font-semibold uppercase tracking-wider text-theme-text-muted mb-3">Theme Presets</h3>
            <div class="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span class="text-[10px] font-semibold text-theme-text text-center">{{ preset.name }}</span>
                <span v-if="preset.id !== 'custom'" class="text-[9px] text-theme-text-muted capitalize mt-1">{{ preset.mode }} Mode</span>
              </button>
            </div>
          </section>
          ...
          <div v-if="activePreset === 'custom'" class="flex flex-col gap-8 animate-in fade-in slide-in-from-top-4 duration-300">
            <!-- Mode Switch -->
            <section>
              <h3 class="text-sm font-semibold uppercase tracking-wider text-theme-text-muted mb-3">Custom Mode</h3>
          ...
          <!-- Colors -->
          <section>
            <h3 class="text-sm font-semibold uppercase tracking-wider text-theme-text-muted mb-3">Color Palette</h3>
            ...
            <div class="space-y-4">
              ...
              <div class="bg-theme-bg p-4 rounded-xl border border-theme-border">
                <div class="flex justify-between items-center mb-2">
                  <span class="text-sm font-medium">Neutral (Base)</span>
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="bg-theme-panel border border-theme-border rounded-xl p-6 flex flex-col justify-center items-center gap-4 transition-colors duration-300">
                <div class="flex gap-4">
                  <button class="px-6 py-2.5 rounded-lg text-white font-medium shadow-lg transition-colors" :style="{ backgroundColor: themeStore.primary }">Primary</button>
                  <button class="px-6 py-2.5 rounded-lg text-white font-medium shadow-lg transition-colors" :style="{ backgroundColor: themeStore.secondary }">Secondary</button>
                </div>
                <div class="flex gap-4">
                  <button class="px-6 py-2.5 rounded-lg border-2 font-medium transition-colors" :style="{ borderColor: themeStore.primary, color: themeStore.primary }">Outlined</button>
                  <button class="px-6 py-2.5 rounded-lg border border-theme-border font-medium hover:bg-theme-border transition-colors">Neutral</button>
                </div>
              </div>
