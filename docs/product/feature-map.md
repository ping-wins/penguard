...
| Integrations | Governed FortiGate traffic-policy orchestration | `apps/api` + `apps/web` | planned | yes | live FortiGate lab required for validation | `AGENTS.md`, `docs/architecture/decisions/ADR-2026-05-15-fortigate-policy-orchestration.md` | Planned: API + web tests plus FortiGate lab runbook validation |
