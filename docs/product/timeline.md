...
| 2026-05-15 | Accepted FortiGate policy orchestration as a product capability. | FortiDashboard may apply governed FortiGate traffic-policy changes through RBAC, preflight, approval and audit instead of draft/mock-only guidance. | [FortiGate policy orchestration ADR](../architecture/decisions/ADR-2026-05-15-fortigate-policy-orchestration.md), [roadmap](roadmap.md), [feature map](feature-map.md) |
| 2026-05-15 | Shipped the first FortiGate policy orchestration slice. | Operators can create a logged lab policy, detect allowed scan telemetry and approve a ticket-linked temporary block through FortiDashboard. | [FortiGate policy orchestration plan](../superpowers/plans/2026-05-15-fortigate-policy-orchestration.md), [feature map](feature-map.md), [FortiGate scan detection runbook](../operations/fortigate-scan-detection.md) |
